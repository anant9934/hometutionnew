  ...
  return (
    <div className="max-w-6xl mx-auto p-4 py-12">
      <div className="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
        <h1 className="font-serif text-3xl md:text-4xl">Tutor Dashboard</h1>
        <div className="flex space-x-4">
          <Link href="/tutor-dashboard/learning" className="bg-indigo-600 hover:bg-indigo-700 text-white px-6 py-2 rounded-full font-medium transition-colors shadow-md text-center">
