  ...
  return (
    <footer className="border-t border-[var(--accent-border)] bg-[var(--background-alt)] py-16 mt-auto">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
        ...
        <div>
          <h4 className="font-medium mb-4 text-xs uppercase tracking-widest text-[var(--accent)]">Connect</h4>
          <p className="text-sm text-[var(--foreground-secondary)]">
            Patna, Bihar, India<br />
            hello@bodhihometuition.in
          </p>
          <p className="text-xs text-[var(--foreground-muted)] mt-8">
            © {new Date().getFullYear()} BODH Tuition. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
